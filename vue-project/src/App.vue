...
<!--
2.This example demonstrates handling user input with the v-on directive.
-->
<!-- 
<script>
export default {
...
<template>
  <h1>{{ message }}</h1>
  <br />
  <button @click="reverseMessage">Reverse The String</button>
  <br />
...
<!-- computed and methods difference -->
